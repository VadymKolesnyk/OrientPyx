...
/// data rows. Mirrors <see cref="OrientDesk.DataAccess"/>'s DocxSummaryProtocolWriter layout so the preview
...
public sealed class SummaryPreviewTable
{
    ...
    private static readonly DataFormat<string> ColumnFormat =
        DataFormat.CreateInProcessFormat<string>("orientdesk-summary-column");
